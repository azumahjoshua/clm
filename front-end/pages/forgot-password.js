...
export default function Index(props) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-bl to-red-100 via-white via-30% from-white">
                                ...
                                <>
                                    ...
                                    <div className="max-w-lg my-4">
                                        ...
                                        <input 
                                            ...
                                            className={`input input-bordered w-full max-w-lg ${errors.email ? 'input-error' : ''}`}
                                            required
                                        />
...
export const getServerSideProps = withSessionSsr(authGuard);
// import Image from "next/image";
// import {useState} from "react";
// import axios from "axios";
